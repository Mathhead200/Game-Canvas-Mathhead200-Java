...
public class Game extends GameCanvas
{
	...
	private boolean pauseOnBlur = false;
	...
	/** The default layer for {@link Drawable}. Equal to <code>0</code>. */
	...
	public boolean getPauseOnBlur() {
		return pauseOnBlur;
	}
	
	public void setPauseOnBlur(boolean pauseOnBlur) {
