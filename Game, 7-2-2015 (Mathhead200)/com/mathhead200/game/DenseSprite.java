...
public class DenseSprite extends Sprite
{
	...
	/**
	 * Tries to compute the location of the left face of this sprite
	 * 	based on its position and hit box. Is the same as a call to
	 * 	{@link #getX()} if no hit box has been set for this sprite.
	 * @return The <code>x</code> coordinate of this sprite's left face.
	 */
	public double getLeftFace() {
		return hitBox == null ? getX() : hitBox.x1() + getX();
	}
	
	/**
	 * Tries to compute the location of the right face of this sprite
	 * 	based on its position and hit box. Is the same as a call to
	 * 	{@link #getX()} if no hit box has been set for this sprite.
	 * @return The <code>x</code> coordinate of this sprite's right face.
	 */
	public double getRightFace() {
		return hitBox == null ? getX() : hitBox.x2() + getX();
	}
	
	/**
	 * Tries to compute the location of the top face of this sprite
	 * 	based on its position and hit box. Is the same as a call to
	 * 	{@link #getY()} if no hit box has been set for this sprite.
	 * @return The <code>y</code> coordinate of this sprite's top face.
	 */
	public double getTopFace() {
		return hitBox == null ? getY() : hitBox.y1() + getY();
	}
	
	/**
	 * Tries to compute the location of the bottom face of this sprite
	 * 	based on its position and hit box. Is the same as a call to
	 * 	{@link #getY()} if no hit box has been set for this sprite.
	 * @return The <code>y</code> coordinate of this sprite's bottom face.
	 */
	public double getBottomFace() {
		return hitBox == null ? getY() : hitBox.y2() + getY();
	}
	
	/**
	 * Tries to compute the location of the front face of this sprite
	 * 	based on its position and hit box. Is the same as a call to
	 * 	{@link #getZ()} if no hit box has been set for this sprite.
	 * @return The <code>z</code> coordinate of this sprite's front face.
	 */
	public double getFrontFace() {
		return hitBox == null ? getZ() : hitBox.z1() + getZ();
	}
	
	/**
	 * Tries to compute the location of the back face of this sprite
	 * 	based on its position and hit box. Is the same as a call to
	 * 	{@link #getZ()} if no hit box has been set for this sprite.
	 * @return The <code>z</code> coordinate of this sprite's back face.
	 */
	public double getBackFace() {
		return hitBox == null ? getZ() : hitBox.z2() + getZ();
	}
}
